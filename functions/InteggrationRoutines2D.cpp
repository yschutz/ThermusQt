...
double Integrate2DSimpson(F2* func, double ax, double bx, double ay, double by, double h)
{
  ...
  do{
    ...
    do{
      ...
      double term = h/3.*h/3.*(func->eval(x0,y0) + 4.*func->eval(x0,y1) + func->eval(x0,y2)
...
//__________________________________________________________________________
double Integrate2DO6(F2* func, double ax, double bx, double ay, double by, double h)
{
  ...
  do{
    ...
    do{
      double f1 = func->eval(xc-dh,yc-dh);
      double f2 = func->eval(xc,yc-dh);
      double f3 = func->eval(xc+dh,yc-dh);
      double f4 = func->eval(xc-dh,yc);
      double f5 = func->eval(xc,yc);
      double f6 = func->eval(xc+dh,yc);
      double f7 = func->eval(xc-dh,yc+dh);
      double f8 = func->eval(xc,yc+dh);
      double f9 = func->eval(xc+dh,yc+dh);

      double term = 4. * h * h *( 16./81. * f5 + 25./324. * (f1+f3+f7+f9) + 10./81. * (f2+f4+f6+f8));
...
//__________________________________________________________________________
double Integrate2DLegendre32(F2* func, double ax, double bx, double ay, double by)
{
...
//__________________________________________________________________________
double Integrate2DLaguerre15Legendre20(F2* func, double ay, double by)
{
  // Integrate 2D function from 0 to infinity using Gauss-Laguerre integration
