...
Prediction Prediction::mInstance = Prediction();

//__________________________________________________________________________
Prediction::Prediction() :mFileDialog(NULL), mParaInfo(NULL),
...
//__________________________________________________________________________
void Prediction::selectParticlesListFile()
{
    // Select the particles list file (files are in Ressources partlist qrc
    // Default value

    QDir dir(":/partlist");

    QString fileName = mFileDialog->getFileName();

    mParticlesList = fileName.prepend(":/particles/");
}

//__________________________________________________________________________
void Prediction::setConstrain()
{
...
//__________________________________________________________________________
//void Prediction::init(QString name)
//{
